	...
	up: (queryInterface, Sequelize) => {
		return queryInterface.bulkInsert(
			...
			[
				...
				{
					title:
						"How would you use 'On Green Dolphin Street' for high school jazz band?",
					subtitle:
						"My thoughts on Bill Evans' recording, and what I would point out to students",
					content:
					...
					authorId: 2,
					image: "https://media.giphy.com/media/t762AXX6ftjN5CHKZ5/giphy.gif",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					...
					content: `Have you ever wondered how broadway performers accomplish maintaining their breath while singing and dancing? Then this article is for you.
					...
					authorId: 2,
					image: "https://media.giphy.com/media/Xxv5i52RNfnpxKim2Q/giphy.gif",
					createdAt: new Date(),
					updatedAt: new Date(),
				},
				{
					...
					content: `In this article, I will discuss the benefits that listening to music has for managing mental health. Research shows that listening
